...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("io.citizenjournalist.as.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("io.citizenjournalist.as.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
